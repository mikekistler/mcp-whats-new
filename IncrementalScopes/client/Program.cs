...
Console.WriteLine(tools.Select(t => t.Name).Aggregate((a, b) => a + "\n" + b));
Console.WriteLine();
...
if (tools.Any(t => t.Name == "get_user_info"))
{
    Console.WriteLine("Calling get_user_info tool...");
...
if (tools.Any(t => t.Name == "make_it_rain"))
{
    Console.WriteLine("Calling make_it_rain tool...");
